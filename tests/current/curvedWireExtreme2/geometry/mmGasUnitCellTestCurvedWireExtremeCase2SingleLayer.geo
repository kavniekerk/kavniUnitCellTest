//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// 
// mmGasUnitCellTestCurvedWireExtremeCase2SingleLayer.geo
//
// Description:
...
p2a1_0 = newp; Point(p2a1_0) = {p+p +2.00*p*exPand,p+p +2.00*p*exPand,-rW+meshLevel*mm +3.00*sp2FacR1Ad, lcWireMesh * mm};                           // centre circle
p2a1_1 = newp; Point(p2a1_1) = {p+p +2.00*p*exPand,p+p +2.00*p*exPand,-2*rW+meshLevel*mm +3.00*sp2FacR1Ad, lcWireMesh * mm};                         // bottom circle
// p2a1_2 = newp; Point(p2a1_2) = {p+p +2.00*p*exPand+rW,p+p +2.00*p*exPand,-rW+meshLevel*mm +3.00*sp2FacR1Ad, lcWireMesh * mm};                     // right circle
p2a1_3 = newp; Point(p2a1_3) = {p+p +2.00*p*exPand,p+p +2.00*p*exPand,0+meshLevel*mm +3.00*sp2FacR1Ad, lcWireMesh * mm};                             // top circle
p2a1_4 = newp; Point(p2a1_4) = {p+p +2.00*p*exPand-rW,p+p +2.00*p*exPand,-rW+meshLevel*mm +3.00*sp2FacR1Ad, lcWireMesh * mm};                        // left circle
...
l1bdh_1_1_bsurfb1 = newl; Line(l1bdh_1_1_bsurfb1) = {ptl2c1, p2b1_1};                                                  // bottom line
...
l1bdh_1_1_bsurfb2 = newl; Line(l1bdh_1_1_bsurfb2) = {ptl2c2, ptsbefminz_1_1_2[0]};                                     // bottom line
...
llbdh_1_1_bsurf1b = newreg; Line Loop(llbdh_1_1_bsurf1b) = { lcpbub1a, l1bdh_1_1_bsurfb2, -ll_bdhbeb_1_1_2[0], -ll_bdhbdb_1_1_2[0], -ll_bdhbcb_1_1_2[0], -ll_bdhbdb_1_1_1[0], -ll_bdhbcb_1_1_1[0], -ll_bdhbbb_1_1_1[0], -l2bdh_1_1_bsurfb1b, -l2b1_2, -l2b1_1, -l1bdh_1_1_bsurfb1 };
...
l1bdh_1_2_bsurfb3 = newl; Line(l1bdh_1_2_bsurfb3) = {ptl2c3, p2a1_1};                                                  // bottom line
...
llbdh_1_2_bsurf3b = newreg; Line Loop(llbdh_1_2_bsurf3b) = { lcpbub2a, l1bdh_1_2_bsurfb3, ll_bdhabb_1_2_1[0], ll_bdhacb_1_2_1[0], ll_bdhadb_1_2_1[0], ll_bdhacb_1_2_2[0], ll_bdhadb_1_2_2[0], ll_bdhaeb_1_2_2[0], l2bdh_1_1_bsurft2b, -ll_bdhbec1_1_1_2[0], -ll_bdhbec0_1_1_2[0], -l1bdh_1_1_bsurfb2 };
...
l1bdh_2_1_bsurfb4 = newl; Line(l1bdh_2_1_bsurfb4) = {ptl2c4, ptsaefminz_1_1_2[0]};                                     // bottom line
...
llbdh_2_1_bsurf4b = newreg; Line Loop(llbdh_2_1_bsurf4b) = { lcpbub3a, l1bdh_2_1_bsurfb4, -ll_bdhaet_1_1_2[0], -ll_bdhadt_1_1_2[0], -ll_bdhact_1_1_2[0], -ll_bdhadt_1_1_1[0], -ll_bdhact_1_1_1[0], -ll_bdhabt_1_1_1[0], l2bdh_1_2_bsurft3b, l2a1_2, l2a1_3, -l1bdh_1_2_bsurfb3 };
...
llbdh_2_2_bsurf6b = newreg; Line Loop(llbdh_2_2_bsurf6b) = { lcpbub4a, l1bdh_1_1_bsurfb1, ll_bdhbbt_1_2_1[0], ll_bdhbct_1_2_1[0], ll_bdhbdt_1_2_1[0], ll_bdhbct_1_2_2[0], ll_bdhbdt_1_2_2[0], ll_bdhbet_1_2_2[0], l2bdh_2_1_bsurft4b, ll_bdhaec0_1_1_2[0], ll_bdhaec1_1_1_2[0], -l1bdh_2_1_bsurfb4 };
...
Physical Surface(physsurf_bd1h1) = { psbdh_1_1_bsurf1t, sbaf_2_2_1[0], sbb_1_1[2], sbc_1_1[2], sbc_1_2[2], sbd_1_1[2], sbd_1_2[2], sbe_1_2[2], saef_2_2_2[0], psbdh_1_1_bsurf1b };               
Physical Surface(physsurf_bd1h2) = { psbdh_1_2_bsurf3t, saaf_1_1_1[0], sab_2_1[2], sac_2_1[2], sac_2_2[2], sad_2_1[2], sad_2_2[2], sae_2_2[2], sbef_1_1_2[0], psbdh_1_2_bsurf3b };               
Physical Surface(physsurf_bd2h1) = { psbdh_2_1_bsurf4t, saaf_2_2_1[0], sab_1_1[2], sac_1_1[2], sac_1_2[2], sad_1_1[2], sad_1_2[2], sae_1_2[2], sbef_2_2_2[0], psbdh_2_1_bsurf4b };               
Physical Surface(physsurf_bd2h2) = { psbdh_2_2_bsurf6t, sbaf_1_1_1[0], sbb_2_1[2], sbc_2_1[2], sbc_2_2[2], sbd_2_1[2], sbd_2_2[2], sbe_2_2[2], saef_1_1_2[0], psbdh_2_2_bsurf6b };               
...
// Physical Surface(physsurf_wire) = { -saaf_1_1_1[], sab_1_1[], sac_1_1[], sad_1_1[], sac_1_2[], sad_1_2[], sae_1_2[], saef_1_1_2[], -saaf_2_2_1[], sab_2_1[], sac_2_1[], sad_2_1[], sac_2_2[], sad_2_2[], sae_2_2[], saef_2_2_2[], -sbaf_1_1_1[], sbb_1_1[], sbc_1_1[], sbd_1_1[], sbc_1_2[], sbd_1_2[], sbe_1_2[], sbef_1_1_2[], -sbaf_2_2_1[], sbb_2_1[], sbc_2_1[], sbd_2_1[], sbc_2_2[], sbd_2_2[], sbe_2_2[], sbef_2_2_2[] };
