//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// 
// mmGasUnitCellTestCurvedWireTestCaseSingleLayer.geo
//
// Description:
...
sbbf_1_1_2[] = {};
sbbf_1_1_2[] = {tmpbb_1_2[0]};

sl_wire_exterior_surface_1b[] = newreg; Surface Loop(sl_wire_exterior_surface_1b) = { sbaf_1_1_1[0], sbb_1_1[], sbb_1_2[], sbbf_1_1_2[0] };
...
Physical Surface(physsurf_1b_wire) = { sbaf_1_1_1[0], sbb_1_1[], sbb_1_2[], sbbf_1_1_2[0] };
...
l1bdh_1_1_bsurft1 = newl; Line(l1bdh_1_1_bsurft1) = {pexet2, pbdhabb_1_2_2[1]};                    // top line
l2bdh_1_1_bsurft1 = newl; Line(l2bdh_1_1_bsurft1) = {pexet1, p1b1_3};                              // top circle
l1bdh_1_1_bsurfb1 = newl; Line(l1bdh_1_1_bsurfb1) = {ptl2c2, pbdhbbb_1_1_2[1]};                    // bottom line
l2bdh_1_1_bsurfb1 = newl; Line(l2bdh_1_1_bsurfb1) = {ptl2c1, p2b1_1};                              // bottom circle

llbdh_1_1_bsurf1t = newreg; Line Loop(llbdh_1_1_bsurf1t) = { lexet1, l1bdh_1_1_bsurft1, ll_bdhabc0_1_2_2[0], ll_bdhabc1_1_2_2[0], -ll_bdhbbt_1_1_1[0], -ll_bdhbbt_1_1_2[0], -l2bdh_1_1_bsurft1 };
llbdh_1_1_bsurf1b = newreg; Line Loop(llbdh_1_1_bsurf1b) = { lcpbub1a, l1bdh_1_1_bsurfb1, -ll_bdhbbb_1_1_1[0], -ll_bdhbbb_1_1_2[0], -l2b1_1, -l2b1_2, -l2bdh_1_1_bsurfb1 };
...
// l1bdh_1_1_bsurfb1b = newl; Line(l1bdh_1_1_bsurfb1b) = {ptl2c2, pbdhabb_1_2_2[1]};               // bottom line


llbdh_1_2_bsurf3t = newreg; Line Loop(llbdh_1_2_bsurf3t) = { lexet2, l1bdh_1_2_bsurft1, l1a1_2, l1a1_3, ll_bdhabb_1_2_2[0], ll_bdhabb_1_2_1[0], -l1bdh_1_1_bsurft1 };
llbdh_1_2_bsurf3b = newreg; Line Loop(llbdh_1_2_bsurf3b) = { lcpbub2a, l1bdh_1_2_bsurfb1, ll_bdhabt_1_2_2[0], ll_bdhabt_1_2_1[0], -ll_bdhbbc0_1_1_2[0], -ll_bdhbbc1_1_1_2[0], -l1bdh_1_1_bsurfb1 };
...
l1bdh_2_1_bsurft4 = newl; Line(l1bdh_2_1_bsurft4) = {pexet4, pbdhbbb_2_2_2[1]};                    // top line, top circle
l1bdh_2_1_bsurfb4 = newl; Line(l1bdh_2_1_bsurfb4) = {ptl2c4, pbdhabb_2_1_2[1]};                    // bottom line, bottom circle

llbdh_2_1_bsurf4t = newreg; Line Loop(llbdh_2_1_bsurf4t) = { lexet3, l1bdh_2_1_bsurft4, -ll_bdhbbc1_2_2_2[0], -ll_bdhbbc0_2_2_2[0], -ll_bdhabt_2_1_1[0], -ll_bdhabt_2_1_2[0], -l1bdh_1_2_bsurft1 };
llbdh_2_1_bsurf4b = newreg; Line Loop(llbdh_2_1_bsurf4b) = { lcpbub3a, l1bdh_2_1_bsurfb4, -ll_bdhabb_2_1_1[0], -ll_bdhabb_2_1_2[0], l2a1_2, l2a1_3, -l1bdh_1_2_bsurfb1 };
...
llbdh_2_2_bsurf6t = newreg; Line Loop(llbdh_2_2_bsurf6t) = { lexet4, l2bdh_1_1_bsurft1, -l1b1_2, -l1b1_1, ll_bdhbbb_2_2_2[0], ll_bdhbbb_2_2_1[0], -l1bdh_2_1_bsurft4 };
llbdh_2_2_bsurf6b = newreg; Line Loop(llbdh_2_2_bsurf6b) = { lcpbub4a, l2bdh_1_1_bsurfb1, ll_bdhbbt_2_2_1[0], ll_bdhbbt_2_2_2[0], ll_bdhabc0_2_1_2[0], ll_bdhabc1_2_1_2[0], -l1bdh_2_1_bsurfb4 };
...
// sl_wire = newreg; Surface Loop(sl_wire) = { saaf_1_1_1[0], sab_1_1[], sab_1_2[], sabf_1_1_2[0], sbaf_1_1_1[0], sbb_1_1[], sbb_1_2[], sbbf_1_1_2[0], saaf_2_2_1[], sab_2_1[], sab_2_2[], sabf_2_2_2[], sbaf_2_2_1[0], sbb_2_1[], sbb_2_2[], sbbf_2_2_2[0] };
...
physsurf_bdh_1_2 = newreg; Physical Surface(physsurf_bdh_1_2) = { psbdh_1_2_bsurf3t, saaf_1_1_1[0], sab_2_1[2], sab_2_2[2], sbbf_1_1_2[0], psbdh_1_2_bsurf3b };               
...
physsurf_bdh_2_2 = newreg; Physical Surface(physsurf_bdh_2_2) = { psbdh_2_2_bsurf6t, sbaf_1_1_1[0], sbb_2_1[2], sbb_2_2[2], sabf_1_1_2[0], psbdh_2_2_bsurf6b };               
...
// physsurf_wire = newreg; Physical Surface(physsurf_wire) = { saaf_1_1_1[0], sab_1_1[], sab_1_2[], sabf_1_1_2[0], sbaf_1_1_1[0], sbb_1_1[], sbb_1_2[], sbbf_1_1_2[0], saaf_2_2_1[], sab_2_1[], sab_2_2[], sabf_2_2_2[], sbaf_2_2_1[0], sbb_2_1[], sbb_2_2[], sbbf_2_2_2[0] };
