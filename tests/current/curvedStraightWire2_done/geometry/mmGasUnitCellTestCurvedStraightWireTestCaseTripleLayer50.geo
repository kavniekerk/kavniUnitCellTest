//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// 
// mmGasUnitCellTestCurvedStraightWireTestCaseTripleLayer50.geo
//
// Description:
...
// Include "mmGasUnitCellTestShellStructureSingleLayer50.geo";
Include "mmGasUnitCellTestShellStructureTripleLayer50.geo";
...
// CHECK 2*0.0225 + 2*0.10*0.0225 = 0.0495
...
l1bdh_1_1_bsurfb1 = newl; Line(l1bdh_1_1_bsurfb1) = {ptl4c2, pbdhbcb_1_1_2[1]};                    // bottom line
...
llbdh_1_1_bsurf1b = newreg; Line Loop(llbdh_1_1_bsurf1b) = { lcptub1a, l1bdh_1_1_bsurfb1, -ll_bdhbcb_1_1_2[0], -ll_bdhbbb_1_1_2[0], -ll_bdhbcb_1_1_1[0], -ll_bdhbbb_1_1_1[0], -l2b1_1, -l2b1_2, -l2bdh_1_1_bsurfb1 };
...
llbdh_1_2_bsurf3b = newreg; Line Loop(llbdh_1_2_bsurf3b) = { lcptub2a, l1bdh_1_2_bsurfb1, ll_bdhabb_1_2_1[0], ll_bdhacb_1_2_1[0], ll_bdhabb_1_2_2[0], ll_bdhacb_1_2_2[0], -ll_bdhbcc1_1_1_2[0], -ll_bdhbcc0_1_1_2[0], -l1bdh_1_1_bsurfb1 };
...
l1bdh_2_1_bsurfb4 = newl; Line(l1bdh_2_1_bsurfb4) = {ptl4c4, pbdhact_1_1_2[1]};                    // bottom line, bottom circle
...
llbdh_2_1_bsurf4b = newreg; Line Loop(llbdh_2_1_bsurf4b) = { lcptub3a, l1bdh_2_1_bsurfb4, -ll_bdhact_1_1_2[0], -ll_bdhabt_1_1_2[0], -ll_bdhact_1_1_1[0], -ll_bdhabt_1_1_1[0], l2a1_2, l2a1_3, -l1bdh_1_2_bsurfb1 };
...
llbdh_2_2_bsurf6b = newreg; Line Loop(llbdh_2_2_bsurf6b) = { lcptub4a, l2bdh_1_1_bsurfb1, ll_bdhbbt_1_2_1[0], ll_bdhbct_1_2_1[0], ll_bdhbbt_1_2_2[0], ll_bdhbct_1_2_2[0], ll_bdhacc0_1_1_2[0], ll_bdhacc1_1_1_2[0], -l1bdh_2_1_bsurfb4 };
...
vol_lower_cp = newreg; Volume(vol_lower_cp) = total_sl_lower_cp[];vol_high_cp = newreg; Volume(vol_high_cp) = total_sl_high_cp[];
...
Physical Surface(physsurf_bd1h1) = { psbdh_1_1_bsurf1t, sbaf_2_2_1[0], sbb_1_1[2], sbb_1_2[2], sbc_1_1[2], sbc_1_2[2], sacf_2_2_2[0], psbdh_1_1_bsurf1b };               
Physical Surface(physsurf_bd1h2) = { psbdh_1_2_bsurf3t, saaf_1_1_1[0], sab_2_1[2], sab_2_2[2], sac_2_1[2], sac_2_2[2], sbcf_1_1_2[0], psbdh_1_2_bsurf3b };               
Physical Surface(physsurf_bd2h1) = { psbdh_2_1_bsurf4t, saaf_2_2_1[0], sab_1_1[2], sab_1_2[2], sac_1_1[2], sac_1_2[2], sbcf_2_2_2[0], psbdh_2_1_bsurf4b };               
Physical Surface(physsurf_bd2h2) = { psbdh_2_2_bsurf6t, sbaf_1_1_1[0], sbb_2_1[2], sbb_2_2[2], sbc_2_1[2], sbc_2_2[2], sacf_1_1_2[0], psbdh_2_2_bsurf6b };               
...
// Physical Surface(physsurf_wire) = { -sbaf_1_1_1[0], sbb_1_1[], sbb_1_2[], sbc_1_1[], sbc_1_2[], sbcf_1_1_2[0], -saaf_1_1_1[0], sab_1_1[], sab_1_2[], sac_1_1[], sac_1_2[], sacf_1_1_2[0], -saaf_2_2_1[0], sab_2_1[], sab_2_2[], sac_2_1[], sac_2_2[], sacf_2_2_2[0], -sbaf_2_2_1[0], sbb_2_1[], sbb_2_2[], sbc_2_1[], sbc_2_2[], sbcf_2_2_2[0] };
